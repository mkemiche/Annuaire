...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'Annuaire', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_442e977d5cbdf117eeb2e46616013f9d');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_442e977d5cbdf117eeb2e46616013f9d');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_442e977d5cbdf117eeb2e46616013f9d');
        ...
        $f->addDriver($e, 'Annuaire\\AnnuaireBundle\\Entity');
        $f->addDriver($e, 'Utilisateurs\\UtilisateurBundle\\Entity');
        ...
        $g->setEntityNamespaces(array('AnnuaireBundle' => 'Annuaire\\AnnuaireBundle\\Entity', 'UtilisateurBundle' => 'Utilisateurs\\UtilisateurBundle\\Entity'));
