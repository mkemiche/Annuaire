...
class __TwigTemplate_6fd22e172bf9a5ca6708285dd1c6389b4f623ae6bbe14065fd3d732ce1fab209 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            ...
            if (isset($context["previous_count"])) { $_previous_count_ = $context["previous_count"]; } else { $_previous_count_ = null; }
            $this->loadTemplate("TwigBundle:Exception:traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(array("exception" => $_e_, "position" => $_position_, "count" => $_previous_count_));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ...
            // line 66
            if (isset($context["logger"])) { $_logger_ = $context["logger"]; } else { $_logger_ = null; }
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(array("logs" => $this->getAttribute($_logger_, "logs", array())));
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        if (isset($context["exception"])) { $_exception_ = $context["exception"]; } else { $_exception_ = null; }
        $this->loadTemplate("TwigBundle:Exception:traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(array("exception" => $_exception_));
        // line 92
        echo "
